...
/**
 * @ClassName: Header
 * @Description:RTMP packet header
 */
public class Header implements Constants, Cloneable, Externalizable {
	...
	public String toString() {
		return "Header [channelId=" + channelId + ", dataType=" + dataType + ", timerBase=" + timerBase + ", timerDelta=" + timerDelta + ", size=" + size + ", streamId=" + streamId + ", extendedTimestamp=" + extendedTimestamp + ", isGarbage=" + isGarbage + "]";
	}
}
